...
Ative o modo **Software Engineer** do Memzy.
...
For every new piece of work, you must always create a dedicated branch using the pattern:
...
* The branch name must be descriptive, kebab-case, and reflect the business intent of the feature.
* All commits related to a feature must live exclusively in its corresponding `feature/[feature-name]` branch.

This ensures traceability, clean history, and safe parallel development.
